...
public:
	...
	bool IsDungeon;
	/*bool IsBaseControl;
	bool IsEventLocation;
	bool DontChangeSpawners;*/ // for Tito
...
void InitLocationEx()
{
  ...
  /*char *IsBaseControl="IsBaseControl";
  char *IsEventLocation="IsEventLocation";
  char *DontChangeSpawners="DontChangeSpawners";*/
  ...
  while (fgets(buffer, BUFFER_SIZE, f)!=NULL)
  {
    ...
    if (strncmp(prefix,buffer,2)==0)
    {
	  ...
	  /*else
	  if (strcmp(IsBaseControl,arg)==0) LocationExArray[curpid].IsBaseControl = (atoi(param) != 0);
	  else
	  if (strcmp(IsEventLocation,arg)==0) LocationExArray[curpid].IsEventLocation = (atoi(param) != 0);
	  else
	  if (strcmp(DontChangeSpawners,arg)==0) LocationExArray[curpid].DontChangeSpawners = (atoi(param) != 0);*/
    }
  }
  fclose(f);
}
...
/*EXPORT bool Location_IsBaseControl(Location& loc) { return LocationExArray[loc.Data.LocPid].IsBaseControl; }
EXPORT bool Location_IsEventLocation(Location& loc) { return LocationExArray[loc.Data.LocPid].IsEventLocation; }
EXPORT bool Location_DontChangeSpawners(Location& loc) { return LocationExArray[loc.Data.LocPid].DontChangeSpawners; }*/
